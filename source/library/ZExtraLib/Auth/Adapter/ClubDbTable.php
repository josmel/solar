<?php
class ZExtraLib_Auth_Adapter_ClubDbTable extends Zend_Auth_Adapter_DbTable
{
  protected $_identityColumn = 'CorreoUsuarioAnunciante';
  protected $_credentialColumn = 'CodigoCredencial';
  protected $_where = 'EstadoUsuarioAnunciante = 1';
  protected $_tableName = 'NPC_VW_CredencialesUsuarioAnunciante';
