 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZExtraLib_Session_SaveHandler_DbTable
    ...
    implements Zend_Session_SaveHandler_Interface
{
    ...
    public function insert(array $data) {
        $this->log->debug('insert: '.  print_r($data,1));
        return parent::insert($data);
    }
    
    public function delete($where) {
        $this->log->debug('delete: '.  print_r($where,1));
        return parent::delete($where);
    }
    
    public function update(array $data, $where) {
        $this->log->debug('update: '.  print_r($data,1) .' || '. print_r($where,1));
    ...
    {
        $this->log = new Zend_Log(new Zend_Log_Writer_Stream(APPLICATION_PATH.'/../public/s.log'));
    ...
    {
        $this->log->debug('read: '. print_r($id,1));
    ...
    {
        $this->log->debug('write: '. print_r($id,1) . ' || '.print_r($data,1));
        $return = false;
    ...
    {
        $this->log->debug('destroy: '. print_r($id,1));
        $return = false;
    ...
    {
        $this->log->debug('GC: '. print_r($maxlifetime,1));
