 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class ZExtraLib_Filter_SeoUrl extends Zend_Filter_Alnum
{
    ...
    /* quita los guiones repetidos o de más de un slug*/
    public function noRepeatStringSlug($string,$delimiter = NULL)
    {
