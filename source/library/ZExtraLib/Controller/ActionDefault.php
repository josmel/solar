<?php
class ZExtraLib_Controller_ActionDefault extends ZExtraLib_Controller_Action {
	...
	if (!Zend_Session::isStarted()) {
        ...
        /*echo "<pre> admin = identity = "; var_dump($this->_sessionAdmin->identity); echo "</pre>";
        echo "<pre> admin = "; var_dump($this->_sessionAdmin); echo "</pre>";
        echo "<pre>user = "; var_dump($this->session); echo "</pre>";
        */
                                    ...
                                    "vehiculos" => array("nombre" => "Mis Vehículos",
                                        ...
                                        array("mis-vehiculos" =>
                                            array("nombre" => "Vehículos Activos",
                                                ...
                                                "ruta" => '/cerokm/vehiculos/mis-vehiculos')
                                         /* ,   "vehiculo-inactivo" =>
                                            array("nombre" => "Vehículos Inactivos",
                                                "action" => 'vehiculo-inactivo',
                                                "ruta" => '/cerokm/vehiculos/vehiculo-inactivo')*/
                                        )
                                    ),
        ...
        if ($this->_request->getModuleName() == 'default') {
            switch ($this->_request->getControllerName()) {
                case 'autosnuevos':$this->view->menuItemSelected_2 = 'selected';
                    break;
                case 'autonuevo-concesionario':
                case 'concesionario':                    
                    $this->view->menuItemSelected_2 = 'selected';
                    break;
